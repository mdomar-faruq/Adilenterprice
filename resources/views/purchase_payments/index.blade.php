        ...
        <div class="page-header mb-4 pt-3">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="h3 fw-bold text-gray-800 mb-0">History of all Company payments and collections.</h2>
                </div>
                <div class="col-auto">
                    <a href="{{ route('purchase_payments.create') }}"
                        ...
                        <span class="fw-bold">New Payment Voucher</span>
                    </a>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.delete-payment', function() {
            let id = $(this).data('id');
            let url = "{{ route('purchase_payments.destroy', ':id') }}".replace(':id', id);
